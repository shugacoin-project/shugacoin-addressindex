...
#if defined(NDEBUG)
# error "Shugacoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Shugacoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s SHUGA additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("shugacoin-scriptch");
...
static bool CheckBlockHeader(const CBlockHeader& block, CValidationState& state, const Consensus::Params& consensusParams, bool fCheckPOW = true)
{
    ...
    // FIXME.SHUGA // check PoW: SKIPPED during downloading headers (IBD)
