...
public:
    CMainParams() {
        ...
        //vSeeds.emplace_back("1seed.shugacoin.org");
...
public:
    CTestNetParams() {
        ...
        consensus.defaultAssumeValid = uint256S("e0e0e42e493ba7b15f7b0fe1a7e66f73b7fd8b3e6e6a7b0e821a6b95040d3826");
        ...
        bech32_hrp = "tshuga";     // bech32: starting with tshuga1q
