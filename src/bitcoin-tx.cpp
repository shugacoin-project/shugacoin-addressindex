...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s shugacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  shugacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded shugacoin transaction") + "\n" +
              "  shugacoin-tx [options] -create [commands]   " + _("Create hex-encoded shugacoin transaction") + "\n" +
              "\n";
